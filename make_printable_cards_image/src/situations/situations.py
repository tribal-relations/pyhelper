from src.situations.situation_card_manager import SituationCardManager
...
class Situations:
    ...
    def get_template_file_name(self) -> str:
        tm = TemplateManager()
        return tm.get_template_file_name_by_size(self.size, title='situation')
